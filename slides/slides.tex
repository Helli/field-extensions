...
\begin{itemize}
	\item The degree is a vectorspace dimension.\pause%these *can* be zero (iff zvs)
	\item However, it is always $\ge 1$.\pause
	\item Thus one can use this encoding: %It could be adapted easily to use extended natural numbers
	%to-do: paint definition of degree here
\end{itemize}
\end{frame}
